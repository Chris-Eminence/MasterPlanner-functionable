...
//        mydb = new DBHelper(this);
    ...
    public void loadListView(ListView listView, final ArrayList<HashMap<String, String>> dataList) {
        com.example.myapplication.ListTaskAdapter adapter = new com.example.myapplication.ListTaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(TodoMainActivity.this, AddModifyTask.class);
