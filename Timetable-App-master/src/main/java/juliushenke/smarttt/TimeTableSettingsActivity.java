...
public class TimeTableSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.time_table_activity_settings);
        ...
        for (EditText hourTimeInput : hourTimeInputs) {
            hourTimeInput.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable editable) {
                    ...
                    final Settings settings = util.readSettings(TimeTableSettingsActivity.this);
                    settings.setHourTimes(hourTimes);
                    util.saveSettings(TimeTableSettingsActivity.this, settings);
                }
            });
        }
    }
    ...
    private void updateActivitySettings() {
        ...
        String[] days = TimeTableMainActivity.res.getStringArray(R.array.days);
    ...
    private Dialog D_warn_manageDays() {
        Resources r = TimeTableMainActivity.res;
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
