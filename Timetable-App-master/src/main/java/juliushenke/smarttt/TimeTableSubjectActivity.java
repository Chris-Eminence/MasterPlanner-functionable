...
public class TimeTableSubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.time_table_activity_subject);
    ...
    public void initializeActivitySubject() {
        ...
        String selectedSubject = TimeTableMainActivity.getSelectedSubject();
        if (TimeTableMainActivity.isNewSubject()) {
    ...
    public void clickB_sub_color(View view) {
        int[] colors = TimeTableMainActivity.res.getIntArray(R.array.preset_colors);

        final ColorPicker presetColorPicker = new ColorPicker(TimeTableSubjectActivity.this);
        presetColorPicker.setTitle(getString(R.string.D_editColor_preset_title))
            ...
            .addListenerButton(getString(R.string.D_editColor_custom), new ColorPicker.OnButtonListener() {
                @Override
                public void onClick(View v, int position, int color) {
                    ColorPickerDialog.Builder builder = new ColorPickerDialog.Builder(TimeTableSubjectActivity.this)
    ...
    public void saveSubject() {
        ...
        if(TimeTableMainActivity.isNewSubject()){
            int selected_hour = TimeTableMainActivity.getSelected_hour();
